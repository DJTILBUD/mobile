        ...
        setState(
          () =>
              _errorMessage = friendlyErrorMessage(
                e,
                fallback: 'Kunne ikke oprette profil. Prøv igen.',
              ),
        );
      }
    } finally {
        ...
        child: Column(
          ...
          children: [
            ...
            _RoleCard(
              ...
              onTap:
                  () => setState(
                    () => _selectedRole = MusicianRole.instrumentalist,
                  ),
            ),
            const Spacer(),
            DSButton(
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 48,
              decoration: BoxDecoration(
                color: selected ? _c.brand.primary : _c.bg.inputBg,
