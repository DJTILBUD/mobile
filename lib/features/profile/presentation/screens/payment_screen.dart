                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: DSSpacing.s2),
                        Text('Navn: DJTILBUD ApS', style: DSTextStyle.labelMd.copyWith(color: _c.text.secondary)),
                        const SizedBox(height: DSSpacing.s1),
                        Text('CVR: 46181786', style: DSTextStyle.labelMd.copyWith(color: _c.text.secondary)),
                        const SizedBox(height: DSSpacing.s1),
