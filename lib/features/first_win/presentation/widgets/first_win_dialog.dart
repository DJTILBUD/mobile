...
const _djSteps = <_Step>[
  _Step(
    ...
    infoBox:
        'Send kunden en SMS og aftal et opkald, det viser professionalismen.',
  ),
  _Step(
    icon: LucideIcons.phone,
    title: 'Kontakt kunden',
    body:
        'Ring til kunden. Gennemgå listen, alle punkter skal afklares inden I lægger på.',
    checklistItems: [
  ...
  _Step(
    ...
    checklistItems: [
      'Bekræft bookingen + evt. ekstra (opsætning, tid, timer)',
      'Sig til kunden: Vi sender faktura på 50% efter samtalen - under forudsætning af, at bookingen er bekræftet',
    ],
    infoBox:
...
const _musicianSoloSteps = <_Step>[
  ...
  _Step(
    ...
    body:
        'Inden samtalen slutter skal faktureringen afklares. Vi sender faktura på 50% efter samtalen,de resterende 50% betales inden arrangementet.',
    checklistItems: [
      'Bekræft bookingen + evt. ekstra (opsætning, tid, sets)',
...
Future<void> showFirstWinDialog(
  ...
  await showDialog<void>(
    ...
    builder:
        (ctx) => _FirstWinDialog(role: role, musicianVariant: musicianVariant),
  );
}
